...
const TARGETS = [
  { template: "kitty.mustache", output: "terminals/kitty/mindthegap.conf" },
  { template: "alacritty.mustache", output: "terminals/alacritty/mindthegap.toml" },
  { template: "wezterm.mustache", output: "terminals/wezterm/mindthegap.toml" },
  { template: "iterm2.mustache", output: "terminals/iterm2/mindthegap.itermcolors" },
  { template: "ghostty.mustache", output: "terminals/ghostty/mindthegap" },
  { template: "foot.mustache", output: "terminals/foot/mindthegap.ini" },
  { template: "windows-terminal.mustache", output: "terminals/windows-terminal/mindthegap.json" },
  { template: "fzf.mustache", output: "cli/fzf/mindthegap.sh" },
  { template: "bat.mustache", output: "cli/bat/mindthegap.tmTheme" },
  { template: "delta.mustache", output: "cli/delta/mindthegap.gitconfig" },
  { template: "lazygit.mustache", output: "cli/lazygit/mindthegap.yml" },
  { template: "tmux.mustache", output: "tmux/mindthegap-theme.conf" },
  { template: "vscode.mustache", output: "editors/vscode/themes/mindthegap-color-theme.json" },
  { template: "zed.mustache", output: "editors/zed/themes/mindthegap.json" },
  { template: "opencode.mustache", output: "cli/opencode/mindthegap.json" },
] as const;
...
export function generate(opts: GenerateOptions = {}): void {
  ...
  const luaPath = path.join(ROOT, "lua/mindthegap/palette.lua");
  ...
  if (opts.check) {
    ...
    checkFile(luaPath, newLua, "lua/mindthegap/palette.lua");
  ...
  console.log("Generated: lua/mindthegap/palette.lua");
